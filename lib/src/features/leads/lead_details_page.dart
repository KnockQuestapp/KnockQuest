                      ...
                      Row(
                        children: [
                          Container(
                            ...
                            child: Center(
                              child: Text(
                                '${lead.firstName.isEmpty ? '' : lead.firstName[0]}${lead.lastName.isEmpty ? '' : lead.lastName[0]}'
                                    .toUpperCase(),
                                style: TextStyle(
