...
CrmProvider _providerFromRaw(dynamic rawProvider, String? displayName) {
  ...
  if (normalizedProvider == 'boldtrail' || normalizedProvider == 'exprealty') {
...
Map<String, String> defaultFieldMappingsForProvider(CrmProvider provider) {
  switch (provider) {
    ...
    case CrmProvider.boldTrail:
      return Map<String, String>.from(_boldTrailDefaultFieldMappings);
  }
}
...
const Map<String, String> _boldTrailDefaultFieldMappings = <String, String>{
  'firstName': 'first_name',
  'lastName': 'last_name',
  'phone': 'phone',
  'email': 'email',
...
class CrmSyncStore {
  ...
  static const List<CrmSyncTarget> _defaultTargets = <CrmSyncTarget>[
    ...
    CrmSyncTarget(
      provider: CrmProvider.boldTrail,
      displayName: 'BoldTrail',
      autoSync: false,
      webhookUrl: '',
      apiKey: '',
      fieldMappings: _boldTrailDefaultFieldMappings,
    ),
  ];
